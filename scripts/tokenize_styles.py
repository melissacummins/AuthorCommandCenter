...
GENERAL_MAP: dict[str, str] = {
    ...
    # gray family — the Profit module (ported from the old Profit-Track app)
    # uses gray where the rest of the app uses slate; same semantic mapping.
    "bg-gray-50": "bg-surface-hover",
    "bg-gray-100": "bg-surface-sunken",
    "bg-gray-200": "bg-edge",
    "bg-gray-300": "bg-edge-strong",
    "border-gray-50": "border-edge-soft",
    "border-gray-100": "border-edge-soft",
    "border-gray-200": "border-edge",
    "border-gray-300": "border-edge-strong",
    "divide-gray-100": "divide-edge-soft",
    ...
    "text-gray-300": "text-content-faint",
