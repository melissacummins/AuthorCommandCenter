  ...
  return (
    <div>
      ...
      <EditorContent
        ...
        className="max-w-[72ch] mx-auto font-serif text-[17px] leading-relaxed text-slate-700 [&_.ProseMirror]:min-h-[65vh] [&_.ProseMirror]:outline-none [&_.ProseMirror_p]:mb-4 [&_.ProseMirror]:cursor-text"
      />
    </div>
  );
}
